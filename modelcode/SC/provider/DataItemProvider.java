...
/**
 * This is the item provider adapter for a {@link SC.Data} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SCPackage.Literals.DATA__DATA_ID,
				 true,
				 false,
				 false,
	...
	protected void addAssetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Data_asset_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Data_asset_feature", "_UI_Data_type"),
				 SCPackage.Literals.DATA__ASSET,
				 true,
				 false,
				 true,
				 null,
