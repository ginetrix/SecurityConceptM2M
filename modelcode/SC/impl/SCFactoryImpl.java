 ...
 * @generated
 */
public class SCFactoryImpl extends EFactoryImpl implements SCFactory {
	/**
	 ...
	 * @generated
	 */
	public static SCFactory init() {
		try {
			SCFactory theSCFactory = (SCFactory)EPackage.Registry.INSTANCE.getEFactory(SCPackage.eNS_URI);
			if (theSCFactory != null) {
				return theSCFactory;
			}
		}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SCPackage.SECURITY_GOAL: return createSecurityGoal();
			case SCPackage.THREAT: return createThreat();
			case SCPackage.CONTROL: return createControl();
			case SCPackage.COMPONENT: return createComponent();
			case SCPackage.FUNCTION: return createFunction();
			case SCPackage.ASSET: return createAsset();
			case SCPackage.SECURITY_CONCEPT: return createSecurityConcept();
			case SCPackage.CONNECTION: return createConnection();
			case SCPackage.DATA: return createData();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case SCPackage.SECURITY_GOAL_CLASS_TYPE:
	 ...
	 */
	@Deprecated
	public static SCPackage getPackage() {
		return SCPackage.eINSTANCE;
	}
