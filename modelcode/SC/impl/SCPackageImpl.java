...
public class SCPackageImpl extends EPackageImpl implements SCPackage {
	 ...
	 * @generated
	 */
	public EReference getSecurityGoal_DependsOnSecurityGoals() {
	 ...
	 * @generated
	 */
	public EReference getThreat_Controls() {
	 ...
	 * @generated
	 */
	public EReference getControl_Asset() {
	 ...
	 * @generated
	 */
	public EReference getControl_Threats() {
	 ...
	 * @generated
	 */
	public EAttribute getControl_AttackPotential() {
	 ...
	 * @generated
	 */
	public EReference getAsset_Controls() {
	 ...
	 * @generated
	 */
	public EAttribute getAsset_AggregatedComponents() {
	...
	public void createPackageContents() {
		...
		createEReference(securityGoalEClass, SECURITY_GOAL__DEPENDS_ON_SECURITY_GOALS);
		...
		createEReference(threatEClass, THREAT__CONTROLS);
		...
		createEReference(controlEClass, CONTROL__ASSET);
		createEReference(controlEClass, CONTROL__THREATS);
		createEAttribute(controlEClass, CONTROL__ATTACK_POTENTIAL);
		...
		createEAttribute(assetEClass, ASSET__AGGREGATED_COMPONENTS);
	...
	public void initializePackageContents() {
		...
		initEReference(getSecurityGoal_DependsOnSecurityGoals(), this.getSecurityGoal(), null, "dependsOnSecurityGoals", null, 0, -1, SecurityGoal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getSecurityGoal_DependsOnSecurityGoals().getEKeys().add(this.getSecurityGoal_SecurityGoalID());
		...
		initEReference(getThreat_Controls(), this.getControl(), this.getControl_Threats(), "controls", null, 0, -1, Threat.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getControl_Asset(), this.getAsset(), this.getAsset_Controls(), "asset", null, 1, -1, Control.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getControl_Threats(), this.getThreat(), this.getThreat_Controls(), "threats", null, 0, -1, Control.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getControl_AttackPotential(), this.getDamages(), "attackPotential", null, 0, 1, Control.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAsset_AggregatedComponents(), ecorePackage.getEString(), "aggregatedComponents", " ", 0, 1, Asset.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (getSecurityGoal_DependsOnSecurityGoals(), 
		   source, 
		   new String[] {
			 "name", "SecurityGoal"
		   });	
