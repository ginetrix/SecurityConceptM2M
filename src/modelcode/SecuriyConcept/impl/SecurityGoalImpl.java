 ...
 * <ul>
 *   <li>{@link SecuriyConcept.impl.SecurityGoalImpl#getSecurityGoalClass <em>Security Goal Class</em>}</li>
 *   <li>{@link SecuriyConcept.impl.SecurityGoalImpl#getDamagePotential <em>Damage Potential</em>}</li>
 *   <li>{@link SecuriyConcept.impl.SecurityGoalImpl#getDependsOnSecurityGoal <em>Depends On Security Goal</em>}</li>
 *   <li>{@link SecuriyConcept.impl.SecurityGoalImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link SecuriyConcept.impl.SecurityGoalImpl#getSecurityGoalID <em>Security Goal ID</em>}</li>
 *   <li>{@link SecuriyConcept.impl.SecurityGoalImpl#getName <em>Name</em>}</li>
 *   <li>{@link SecuriyConcept.impl.SecurityGoalImpl#getAsset <em>Asset</em>}</li>
 *   <li>{@link SecuriyConcept.impl.SecurityGoalImpl#getThreat <em>Threat</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SecurityGoalImpl extends MinimalEObjectImpl.Container implements SecurityGoal {
	...
	protected EClass eStaticClass() {
		return SecuriyConceptPackage.Literals.SECURITY_GOAL;
	}
	...
	public void setSecurityGoalClass(SecurityGoalClassType newSecurityGoalClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecuriyConceptPackage.SECURITY_GOAL__SECURITY_GOAL_CLASS, oldSecurityGoalClass, securityGoalClass));
	}
	...
	public void setDamagePotential(Damages newDamagePotential) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecuriyConceptPackage.SECURITY_GOAL__DAMAGE_POTENTIAL, oldDamagePotential, damagePotential));
	}
	...
	public EList<SecurityGoal> getDependsOnSecurityGoal() {
		if (dependsOnSecurityGoal == null) {
			dependsOnSecurityGoal = new EObjectResolvingEList<SecurityGoal>(SecurityGoal.class, this, SecuriyConceptPackage.SECURITY_GOAL__DEPENDS_ON_SECURITY_GOAL);
		}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecuriyConceptPackage.SECURITY_GOAL__DESCRIPTION, oldDescription, description));
	}
	...
	public void setSecurityGoalID(int newSecurityGoalID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecuriyConceptPackage.SECURITY_GOAL__SECURITY_GOAL_ID, oldSecurityGoalID, securityGoalID));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecuriyConceptPackage.SECURITY_GOAL__NAME, oldName, name));
	}
	...
	public Asset getAsset() {
		if (asset != null && asset.eIsProxy()) {
			...
			if (asset != oldAsset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SecuriyConceptPackage.SECURITY_GOAL__ASSET, oldAsset, asset));
			}
		}
		return asset;
	}
	...
	public NotificationChain basicSetAsset(Asset newAsset, NotificationChain msgs) {
		...
		asset = newAsset;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SecuriyConceptPackage.SECURITY_GOAL__ASSET, oldAsset, newAsset);
	...
	public void setAsset(Asset newAsset) {
		if (newAsset != asset) {
			...
			if (asset != null)
				msgs = ((InternalEObject)asset).eInverseRemove(this, SecuriyConceptPackage.ASSET__SECURITYGOAL, Asset.class, msgs);
			if (newAsset != null)
				msgs = ((InternalEObject)newAsset).eInverseAdd(this, SecuriyConceptPackage.ASSET__SECURITYGOAL, Asset.class, msgs);
			msgs = basicSetAsset(newAsset, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecuriyConceptPackage.SECURITY_GOAL__ASSET, newAsset, newAsset));
	}
	...
	public EList<Threat> getThreat() {
		if (threat == null) {
			threat = new EObjectWithInverseResolvingEList.ManyInverse<Threat>(Threat.class, this, SecuriyConceptPackage.SECURITY_GOAL__THREAT, SecuriyConceptPackage.THREAT__SECURITYGOAL);
		}
		return threat;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SecuriyConceptPackage.SECURITY_GOAL__ASSET:
				if (asset != null)
					msgs = ((InternalEObject)asset).eInverseRemove(this, SecuriyConceptPackage.ASSET__SECURITYGOAL, Asset.class, msgs);
				return basicSetAsset((Asset)otherEnd, msgs);
			case SecuriyConceptPackage.SECURITY_GOAL__THREAT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SecuriyConceptPackage.SECURITY_GOAL__SECURITY_GOAL_CLASS:
				return getSecurityGoalClass();
			case SecuriyConceptPackage.SECURITY_GOAL__DAMAGE_POTENTIAL:
				return getDamagePotential();
			case SecuriyConceptPackage.SECURITY_GOAL__DEPENDS_ON_SECURITY_GOAL:
				return getDependsOnSecurityGoal();
			case SecuriyConceptPackage.SECURITY_GOAL__DESCRIPTION:
				return getDescription();
			case SecuriyConceptPackage.SECURITY_GOAL__SECURITY_GOAL_ID:
				return getSecurityGoalID();
			case SecuriyConceptPackage.SECURITY_GOAL__NAME:
				return getName();
			case SecuriyConceptPackage.SECURITY_GOAL__ASSET:
