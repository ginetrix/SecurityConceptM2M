...
/**
 * This is the item provider adapter for a {@link SecuriyConcept.Asset} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssetItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SecuriyConceptPackage.Literals.ASSET__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SecuriyConceptPackage.Literals.ASSET__ASSET_ID,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Securitygoal feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSecuritygoalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Asset_securitygoal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Asset_securitygoal_feature", "_UI_Asset_type"),
				 SecuriyConceptPackage.Literals.ASSET__SECURITYGOAL,
				 true,
				 false,
				 true,
				 null,
