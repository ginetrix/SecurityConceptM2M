...
If the availability of one sub-component is being threatened it will also propagate to its parental nodes. This however does not mean that in case of an attack on the availability of $C_{n.i}$ the whole component $C_n$ will no longer be available. The availability of $C_n$ is a union of availabilities of its sub-components and one threat on a specific $C_{n.i}$ would alter said set.
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.85]{pictures/control.png}
