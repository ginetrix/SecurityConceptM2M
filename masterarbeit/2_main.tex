...
\hline
Asset & - & Digital or physical object of interest \\ 
 & & that should be secured & Sensible user data \\
\hline
Security Goal Class & - & Defines the purpose of the Security Goal & Confidentiality of sensible user data \\
\hline
Security Goal & Security Goal Class, \\
& Asset & Defines the security objective & The Confidentiality of sensible user data shall be protected \\
\hline
