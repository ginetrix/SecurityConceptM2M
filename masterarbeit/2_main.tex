...
To put the different elements of the metamodel into a security context one has to clearly define the Security Goal Classes for possible assets. Moreover is it important to consider the edge-cases of such an interpretation and possible pitfalls.
...
\subsubsection{Edge-cases and potential pitfalls}
