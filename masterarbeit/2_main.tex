...
Let $L_{sg}$ be the set of security goals for a component $C_i$. After iterating through the SUS and deriving security goals we receive the following set:

\begin{align*}
L_{sg} = \{&SG(I,C_i,C_i,"low"),\\ &SG(C,C_i,D_j, "medium"),\\ &SG(I,C_i,C_i,"high"),\\ &SG(C,C_i,D_j, "medium")\} \\
\end{align*}
...
\begin{align*}
L_{sg} = \{&SG(I,C_i,C_i,"high"),\\ &SG(C,C_i,D_j, "medium")\} \\
\end{align*}
...
Now we have to adjust the connections. 
