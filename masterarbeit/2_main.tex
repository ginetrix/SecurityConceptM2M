...
$L_c$ $\gets$ \text{list of components} \\
$L_{sg}$ $\gets$ \text{list of security goals} \\

\begin{algorithmic}[1]

\Function{compute\_sg}{$L_{cid}$, security\_concept}\\
$L_c$ = findComponentsByID($L_{cid}$)
\ForAll{component in $L_c$ } 
...
\State checkSecurityGoalCorrectness($L_{sg}$) \
\EndFunction
